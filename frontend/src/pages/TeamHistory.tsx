  ...
  return (
    <div className="page">
      ...
      <p>
        ...
        currently covering EPL, NFL, NBA, NHL, URC, all 36 UCL clubs, and the top 100 teams by
        expected fantasy points in each of NCAAF, NCAAMB, and NCAAWB, ahead of doing the same
        research pass for the other leagues.
      </p>
